...
canvas.create_text(650, 60, text="Vehicle Detection Using Live Camera", fill="black", font=('Helvetica 25 bold'))
...
upload2 = tk.PhotoImage(file="Open_camera_icon.png")
...
text_widget = tk.Label(window, text ="If Scanned Number is correct then click on \nSearch Button to get Info.Else if Scanned \nNumber is Worng. Then point the camera \ntowards the number plate and scan it again", font=('Helvetica 14 bold'), bg="white",borderwidth=0)
